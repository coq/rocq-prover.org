...
- [Source
  tarball](https://github.com/rocq-prover/rocq-prover/archive/refs/tags/V8.20.1.tar.gz)
  (`.tar.gz`) for compilation under Unix (including Linux and macOS X)
  and Microsoft Windows (including Cygwin).
- Also available in
  [`.zip`](https://github.com/rocq-prover/rocq-prover/archive/refs/tags/V8.20.1.zip)
  format.
